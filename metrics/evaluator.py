...
def main():
    ...
    parser.add_argument("--ref_batch", type=str, default='./DPM-OT-results/test_cifar.npz', help="path to reference batch npz file")
    parser.add_argument("--sample_batch", type=str, default='./DPM-OT-results/gen_OT_cifar.npz', help="path to sample batch npz file")
    ...
    #sample_acts = sample_acts[0:40000]
